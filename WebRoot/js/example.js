	...
	_weui2.default.uploader('#uploader', {
	    ...
	    onBeforeQueued: function onBeforeQueued(files) {
	        ...
	        if (["image/jpg", "image/jpeg", "image/png", 
	             	...
	             	"application/msword", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"].indexOf(this.type) < 0) {
	            _weui2.default.alert('请选择指定类型的文件！');
	            return false;
	        }
...
//	    url: 'http://localhost:8002/upload',
	    url: 'http://www.2510491430.com.tunnel.qydev.com/wechat-access/servlet/UploadServlet',
	    auto: false,
	    onQueued: function onQueued() {
